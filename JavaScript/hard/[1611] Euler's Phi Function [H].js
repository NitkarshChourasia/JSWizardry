...
[algorithms] [higher_order_functions] [math] [numbers] 
...
Counts the positive integers up to a given integer n that are relatively prime to n. It is written using the Greek letter phi as φ(n) or ϕ(n), and may also be called Eu …
_________
_________
Coprime Integers
https://en.wikipedia.org/wiki/Coprime_integers
Two integers a and b are said to be relatively prime, mutually prime,[1] or coprime (also written co-prime) if the only positive integer (factor) that divides both of t …
_________

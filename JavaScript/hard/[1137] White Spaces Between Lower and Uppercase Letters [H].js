...
Returns a new string with some or all matches of a pattern replaced by a replacement. The pattern can be a string or a {{jsxref("RegExp")}}, and the replacement can be …
_________
_________
How to insert a space before capital letters?

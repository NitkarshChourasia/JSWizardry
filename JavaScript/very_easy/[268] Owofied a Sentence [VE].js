...
If you use "g" flag of regex then it will work case sensitive if you want to run it will small letter will work only for small letter characters. if you use "gi" flag t …
_________
_________

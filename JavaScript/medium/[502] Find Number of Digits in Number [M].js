...
_________
Video Explanation
https://youtu.be/wtoEZsVQ8Wg
Reviews how to solve this problem both with a string solution and one without the use of strings.
_________
_________
Math.abs()
...
Returns either a positive or negative +/- 1, indicating the sign of a number passed into the argument. If the number passed into Math.sign() is 0, it will return …
_________
_________
Regular Expressions

...
Divides a String into an ordered set of substrings, puts these substrings into an array, and returns the array.
_________
_________
...
You can .split() to get an array of strings, then loop through to convert them to numbers, like this: var myArray = "14 2".split(" "); for(var i=0; i<myArray.length; i+ …
_________
_________

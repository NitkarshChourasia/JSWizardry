...
Allows you to have an expression (a piece of code that results in a single value like a variable or function invocation) be computed as a property name on an object.
_________
_________
Object.assign()
...
An object is a collection of properties, and a property is an association between a name (or key) and a value (...)However, any property name that is not a valid JavaSc …
_________
_________
Spread syntax (...)
